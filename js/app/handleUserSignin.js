 ...
 */
//====================================================================================================================//
define(["lib/i18n.min!nls/resources.js", "js/app/register_controller"], function(i18n, register_controller) {
  "use strict";
  ...
  handleUserSignin = {
    ...
    initUI: function(actionButtonContainer) {
        console.log(handleUserSignin.availabilities.guest);
      if (handleUserSignin.availabilities.guest) {
        $("<div id='guestSignin' class='splashInfoActionButton guestOfficialColor'>" +
          ...
          "<div id='logowanie'> <img src='images/Login.png' alt=''>" +
        ...
        $("<div id='rejestracja' class='splashInfoActionButton guestOfficialColor'><img src='images/register.png' alt=''>" +
          "<span style='display: block;'>Rejestracja</span> </div>").appendTo(actionButtonContainer)

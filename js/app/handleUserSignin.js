...
define(["lib/i18n.min!nls/resources.js",
  ...
  "app/tokenUtil", "app/splash"
], function(i18n, register_controller, tokenUtil, splash) {
  "use strict";
  ...
  handleUserSignin = {
    ...
    showResendPanel: function(username) {
      ...
      p.innerHTML = 'Twoje konto jest niezweryfikowane. Żeby je zweryfikować znajdź maila na swoim adresie.' +
        ' W przypadku jego braku naciśnij poniższy link<br/>';
        $(p).css('color','red');
